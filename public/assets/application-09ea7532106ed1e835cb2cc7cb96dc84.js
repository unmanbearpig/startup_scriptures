...
(function() {
  ...
  reorderCategories = function(category_ids) {
    return $.post(gon.reorder_categories_path, {
      category_ids: category_ids
    });
  };

  $(document).ready(function() {
    var handle_selector, selector;
    ...
    $(selector).sortable({
      ...
      beforeStop: function(event, ui) {
        var categoriesOrder;
        categoriesOrder = $(selector).sortable('toArray', {
          attribute: 'data-category-id'
        });
        return reorderCategories(categoriesOrder);
      }
    });
    $(handle_selector).disableSelection();
    $('.link-star').on('ajax:success', function(e, data, status, xhr) {
      return console.log('on star');
    });
    return $('link-star-empty').on('ajax:success', function(e, data, status, xhr) {
      return console.log('on empty star');
    });
  });
...
(function() {
  var reorderSubcategories;

  reorderSubcategories = function(category_ids) {
    return $.post(gon.reorder_subcategories_path, {
  ...
  $(document).ready(function() {
    ...
    $(selector).sortable({
      ...
      forcePlaceholderSize: true,
      beforeStop: function(event, ui) {
        var subcategoriesOrder;
        subcategoriesOrder = $(selector).sortable('toArray', {
          attribute: 'data-subcategory-id'
        });
        return reorderSubcategories(subcategoriesOrder);
      }
    });
    return $(handle_selector).disableSelection();
  });
